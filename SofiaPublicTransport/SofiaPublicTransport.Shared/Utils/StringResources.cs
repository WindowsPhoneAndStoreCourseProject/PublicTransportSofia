namespace SofiaPublicTransport.Utils
{
    ...
    {
        public const string SofiaTrafficBaseURL = "http://m.sofiatraffic.bg";
        public const string VirtualTablesBaseURL = "http://m.sofiatraffic.bg/vt";
        public const string SetCookie = "Set-Cookie";
        public const string CookieNameInLocalSettings = "Cookies";
